	...
	"OpenMPT " + OPENMPT_VERSION_MAJORMAJOR + "." + OPENMPT_VERSION_MAJOR: {
		...
		"downloads": {
			"installer": {
				...
				"os": "arch",
				"required_arch_version": { "version_major":6, "version_minor":1, "servicepack_major":1, "servicepack_minor":0, "build":0, "wine_major":1, "wine_minor":8, "wine_update":0 },
			...
			"portable-x86": {
				...
				"autoupdate_minversion": "1.30.00.08",
				"os": "arch",
				"required_arch_version": { "version_major":10, "version_minor":0, "servicepack_major":0, "servicepack_minor":0, "build":0, "wine_major":1, "wine_minor":8, "wine_update":0 },
			...
			"portable-x86-legacy": {
				...
				"autoupdate_minversion": "1.30.00.08",
				"os": "arch",
				"required_arch_version": { "version_major":6, "version_minor":1, "servicepack_major":0, "servicepack_minor":0, "build":0, "wine_major":1, "wine_minor":8, "wine_update":0 },
				"required_architectures": {},
				"supported_architectures": { "x86":True },
				"required_processor_features": { "x86":{"sse2":True} }
			},
