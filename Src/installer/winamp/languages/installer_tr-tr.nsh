...
${LangFileString} safeMode "Winamp (Güvenli Kip)"
...
${LangFileString} msgWMAError "Bileşenler kurulurken bir sorun oluştu. WMA Kodlayıcı kurulamadı. Lütfen http://www.microsoft.com/arch/archmedia/9series/encoder/ web sitesinden kodlayıcıyı indirin ve tekrar deneyin."
...
${LangFileString} IDS_PAGE_WELCOME_LEGAL	"'İleri' düğmesine tıklamak, $(^NameDA) <a id=$\"winamp_eula$\">Son Kullanıcı Lisans Sözleşmesi</a> ve <a id=$\"winamp_privacy_policy$\">Gizlilik İlkesi</a>'ni kabul etmiş sayılırsınız."
!else
...
${LangFileString} IDS_SEC_ML_ONLINE_DESC		"Çevrimiçi Servisler, SHOUTcast Radyo & TV, AOL Radio, CBS Radio, Winamp Charts ve daha fazlası"
...
${LangFileString} IDS_UNINSTALL_FILES_NOT_REMOVED		"$\r$\n$\r$\n$\r$\nNot: Tüm dosyalar kaldırılamadı. İçeriği görmek için Winamp klasörünü açın."
