...
${LangFileString} msgWMAError 		"Er is een probleem opgetreden bij de installatie van bepaalde componenten. De WMA-encoder zal niet worden geïnstalleerd. Ga naar http://www.microsoft.com/arch/archmedia/9series/encoder/ , download de encoder en probeer het opnieuw."
