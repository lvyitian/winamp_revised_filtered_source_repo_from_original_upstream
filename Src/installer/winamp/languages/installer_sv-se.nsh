...
${LangFileString} msgWMAError "Det inträffade ett fel när komponenter installerades. WMA Encoder installeras inte. Gå till http://www.microsoft.com/arch/archmedia/9series/encoder/, hämta kodaren och försök igen."
