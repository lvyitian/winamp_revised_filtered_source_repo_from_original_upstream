...
${LangFileString} msgWMAError "Si era verificato un problema durante l'installazione dei componenti. Il codificatore WMA non sarà installato. Si prega di visitare il sito http://www.microsoft.com/arch/archmedia/9series/encoder/ , scarica il codificatore e riprova di nuovo."
