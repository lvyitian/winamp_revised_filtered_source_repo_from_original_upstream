...
${LangFileString} msgWMAError "При установке некоторых компонентов возникли проблемы. Не удалось установить кодер Windows Media Audio. Чтобы загрузить и установить его вручную, перейдите по адресу http://www.microsoft.com/arch/archmedia/9series/encoder и повторите попытку"
