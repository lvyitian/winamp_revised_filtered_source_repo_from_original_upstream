...
${LangFileString} msgWMAError "コンポーネントのインストール中に問題が発生しました。WMA エンコーダはインストールされませんでした。http://www.microsoft.com/arch/archmedia/9series/encoder/ を参照してエンコーダをダウンロードしてもう一度試してください。"
